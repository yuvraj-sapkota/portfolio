          ...
          <div className="   flex flex-col  gap-4 ">
            <div className="bg-white rounded-2xl py-6 px-4 flex items-start  flex-col gap-4">
              ...
              <p className=" font-serif text-black">
                👋 Hi, I’m a web developer & tech content creator based in
                Nepal. I build real-world apps using MERN stack, and I love
              ...
              <p className=" font-serif text-black">
                🎥 I also share coding tips & tutorials on Instagram through
                daily reels — helping others grow while growing myself.
              </p>
            </div>
            <div className="bg-white rounded-2xl   py-6 px-4">
              <ul className="flex flex-col gap-4  font-serif text-black">
